...
public class NewGamePagController {
    ...
    @FXML
    private void randomCreatF() throws Exception {  // cree de maniere aleatoire les joueurs necessaires au deroulement du jeu
        try {
    ...
    @FXML
    private void goBack() throws Exception { // retourne au menu de base
        try {
    ...
    @FXML
    private void loadListe() throws Exception { // permet de charger une lsite de joueur txt
        try {
    ...
    @FXML
    private void setYear() throws Exception {   //permet de choisir l'annee du jeu
        try {
